package ci.ivb.libraryeventproducer.util;


import ci.ivb.libraryeventproducer.domain.Book;
...
public class TestUtil {
    ...
    public static Book bookRecord(){
        ...
        return new Book(123, "YAO","Kafka For Spring Boot" );
    }

    public static Book bookRecordWithInvalidValues(){

        return new Book(null, "","Kafka For Spring Boot" );
    }
